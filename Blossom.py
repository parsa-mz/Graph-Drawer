...
class Graph:
    def __init__(self):
        self.vertices = []
        self.edges = []
        self.connected = []#[False for x in range(v)]

    def init_connected(self):
        self.connected = [False for x in self.vertices]
        
    def kick_out_alone_vertex(self):
        new_vertice, kick_i = [], []
        for i in range(len(self.vertices)):
            if self.connected[i]:
                new_vertice.append(self.vertices[i])
            else:
                kick_i.append(i)
